...
console.log('new Sum ' + newSum(1, 2, 3, 4));
...
// const Stu = (name, age, hometown) => {
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// }
// let joie = new Stu('Joie', 'Schmoe', 100);
// console.log(joie);
...
// 1. this reffers to joe object.
// 2. this reffers to the window object.
// 3. This is because the joe.scopeArrow() is called from a global context, and this will
//    refer to a global object. In this case, a global object window is called from the browser.
//    this is not defined by the caller.Thus, it will turn to the default window object.